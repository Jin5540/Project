    ...
    <br>
      ...
      <p class="lead"></p>
         ...
         <div class="col-sm-12">
              ...
              <input type="text" class="form-control" name="Link" value="${board.link}" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-12">
              ...
              <textarea class="form-control" style="width:100%;height:100px"; name="Configuration" required>${board.configuration}</textarea>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
              ...
              <textarea class="form-control" style="width:100%;height:100px"; name="Opinion" required>${board.opinion}</textarea>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
              ...
              <input type="text" class="form-control" name="Language" value="${board.language}" required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
              ...
              <input type="text" class="form-control" height="200" name="Date" value="${board.date}" required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>   
           ...
           <div class="col-sm-12">
              ...
              <input type="file" class="form-control" name="Picture1" id="Picture1" required>
              <div class="invalid-feedback">
